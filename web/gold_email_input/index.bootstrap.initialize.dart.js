...
C.a0=new X.Q("gold-email-input",null)
...
C.V=new T.ii()
C.au=I.w([C.af,C.ae,C.X,C.W,C.aD,C.U,C.Z,C.Y,C.aB,C.aA,C.V])
C.a=new B.hl(!0,null,null,null,null,null,null,null,null,null,null,C.au)
C.ao=H.c(I.w([0]),[P.j])
...
C.D=new T.cq(null,"gold-email-input-demo",null)
...
C.aY=H.l("ej")
C.aJ=H.l("ao")
C.ax=H.c(I.w([C.t,C.aR,C.aa,C.aX,C.ab,C.P,C.p,C.o,C.r,C.m,C.aY,C.aJ]),[P.ej])
C.B=I.w(["registered","beforeRegister"])
C.av=H.c(I.w([]),[P.aI])
C.C=H.c(new H.d7(0,{},C.av),[P.aI,null])
C.h=new H.d7(0,{},C.j)
C.aC=new H.ct("call")
C.F=H.l("c0")
C.aE=H.l("l2")
...
init.typeToInterceptorMap=[C.q,W.o,{},C.P,N.aF,{created:N.hG},C.p,K.br,{created:K.fR},C.o,E.bo,{created:E.fF},C.F,U.c0,{created:U.fp},C.G,X.c6,{created:X.fH},C.H,M.c7,{created:M.fI},C.I,Y.c8,{created:Y.fK},C.J,N.cb,{created:N.fQ},C.K,G.cd,{created:G.h1},C.L,F.cf,{created:F.h3},C.M,F.ce,{created:F.h2},C.N,T.co,{created:T.hB},C.O,Y.cp,{created:Y.hC}];(function(a){for(var z=0;z<a.length;){var y=a[z++]
var x=a[z++]
var w=a[z++]
