...
*/
@HtmlImport('iron_list_collapse_demo.html')
...
class IronListCollapseDemo extends PolymerElement with PolymerBase {
  ...
  @reflectable
  void collapseExpand(dom.CustomEvent event, [_]) {
    IronList list = $['list'];
    ...
    var isExpanded = items[index].expanded;

    set('items.$index.expanded', !isExpanded);
  ...
  @reflectable
  String getClassForItem(Map item, bool expanded) =>
