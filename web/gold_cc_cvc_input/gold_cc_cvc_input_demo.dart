...
*/
@HtmlImport('gold_cc_cvc_input_demo.html')
library polymer_elements.demo.web.gold_cc_cvc_input.gold_cc_cvc_input_demo;
...
class GoldCcCvcInputDemo extends PolymerElement {
  GoldCcCvcInputDemo.created() : super.created();
}
