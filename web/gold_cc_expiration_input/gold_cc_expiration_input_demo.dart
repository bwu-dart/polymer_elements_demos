...
@HtmlImport('gold_cc_expiration_input_demo.html')
library polymer_elements.demo.web.gold_cc_expiration_input.gold_cc_expiration_input_demo;
...
class GoldCcExpirationInputDemo extends PolymerElement {
  GoldCcExpirationInputDemo.created() : super.created();
}
